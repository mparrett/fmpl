...
- **9722f083bd4c** (priority=1728.00, size=96, rejections=0) — FAILURE in claude-code: Command failed: jj new -m "docs(iter-0004d.4): scenario 
...
- **5243c8cb6b09** (priority=607.50, size=45, rejections=0) — Wrote /Users/ndn/development/fmpl/docs/superpowers/specs/2026-05-12-scenario-run
