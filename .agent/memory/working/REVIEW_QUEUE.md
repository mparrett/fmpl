...
- **70c3e012fa1b** (priority=9180.00, size=510, rejections=0) — FAILURE in claude-code: Command failed: jj new -m "docs(iter-0004d.4): scenario 
...
- **65dca9e74421** (priority=169.71, size=11, rejections=0) — High-stakes op completed (schema): python3 .agent/tools/reject.py 50986dd6bff7 -
