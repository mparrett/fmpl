...
///
/// By default, uses the legacy hand-written parser.
/// Set the environment variable `FMPL_USE_GENERATED_PARSER=1` to use the
/// generated scannerless parser (experimental).
